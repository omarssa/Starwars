...
class PViewController: UIViewController {
    ...
    func loadFirstNames() {
        isLoading = true
        NetworkService.getPlanet{ error,result in
            if let _ = error {
...
private typealias collectionViewDataSource = PViewController
...
private typealias collectionViewDelegate = PViewController
