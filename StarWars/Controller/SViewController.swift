...
class SViewController: UIViewController {
    ...
    func loadFirstNames() {
        isLoading = true
        NetworkService.getStarship{ error,result in
            if let _ = error {
...
private typealias collectionViewDataSource = SViewController
...
private typealias collectionViewDelegate = SViewController
